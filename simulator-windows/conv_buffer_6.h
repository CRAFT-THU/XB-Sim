#ifndef _CONV_BUFFER_6
#define _CONV_BUFFER_6
...
// convolution buffer 6, input channels CHANNELS_80, output channels CHANNELS_80
// image size IMAGE_SIZE_16

SC_MODULE(conv_buffer_6) {
