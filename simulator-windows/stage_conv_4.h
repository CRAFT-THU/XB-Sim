...
// fifth convolution layer, input channel CHANNELS_32, output channel CHANNELS_48, pooling POOLING_SIZE_1
...
SC_MODULE(stage_conv_4) {
	...
	CROSSBAR cb;
	float pooling_buffer[CHANNELS_48][IMAGE_SIZE_32*POOLING_SIZE_1];
	int pooling_pointer;
	int print;
	...
	void init_crossbar() {
		...
		string filename = "./weights/weight_4.csv";
		...
		delete[] cell;
		cout << "load weights 4 complete. " << filename << endl;
		// cb.printcrossbar();
