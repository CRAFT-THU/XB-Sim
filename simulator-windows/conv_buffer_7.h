#ifndef _CONV_BUFFER_7
#define _CONV_BUFFER_7
...
// convolution buffer 7, input channels CHANNELS_80, output channels CHANNELS_80
// image size IMAGE_SIZE_16

SC_MODULE(conv_buffer_7) {
