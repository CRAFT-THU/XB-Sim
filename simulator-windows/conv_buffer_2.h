#ifndef _CONV_BUFFER_2
#define _CONV_BUFFER_2
...
// convolution buffer 2, input channels CHANNELS_32, output channels CHANNELS_32
// image size IMAGE_SIZE_32

SC_MODULE(conv_buffer_2) {
