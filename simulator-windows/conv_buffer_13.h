#ifndef _CONV_BUFFER_13
#define _CONV_BUFFER_13
...
// convolution buffer 13, input channels 128, output channels 128
// image size 8

SC_MODULE(conv_buffer_13) {
