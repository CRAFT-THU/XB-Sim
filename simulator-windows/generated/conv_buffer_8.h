#ifndef _CONV_BUFFER_8
#define _CONV_BUFFER_8
...
// convolution buffer 8, input channels CHANNELS_80, output channels CHANNELS_80
// image size IMAGE_SIZE_16

SC_MODULE(conv_buffer_8) {
