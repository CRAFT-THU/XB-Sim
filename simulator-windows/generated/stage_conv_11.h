...
// fifth convolution layer, input channel CHANNELS_80, output channel CHANNELS_128, pooling POOLING_SIZE_1
...
SC_MODULE(stage_conv_11) {
	...
	void init_crossbar() {
		...
		string filename = "./weights/weight_11.csv";
		...
		delete[] cell;
		cout << "load weights 11 complete. " << filename << endl;
		// cb.printcrossbar();
