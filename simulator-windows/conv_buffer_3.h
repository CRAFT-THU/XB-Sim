#ifndef _CONV_BUFFER_3
#define _CONV_BUFFER_3
...
// convolution buffer 3, input channels CHANNELS_32, output channels CHANNELS_32
// image size IMAGE_SIZE_32

SC_MODULE(conv_buffer_3) {
